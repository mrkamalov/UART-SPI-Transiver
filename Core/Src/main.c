...
/* Definitions for uartTransiver */
osThreadId_t uartTransiverHandle;
const osThreadAttr_t uartTransiver_attributes = {
  .name = "uartTransiver",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for spiTransiver */
osThreadId_t spiTransiverHandle;
const osThreadAttr_t spiTransiver_attributes = {
  .name = "spiTransiver",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
/* Definitions for spiSendQueue */
osMessageQueueId_t spiSendQueueHandle;
const osMessageQueueAttr_t spiSendQueue_attributes = {
  .name = "spiSendQueue"
};
/* Definitions for uartSendSem */
osSemaphoreId_t uartSendSemHandle;
...
/* USER CODE BEGIN Header_uartTransiverTask */
/**
  * @brief  Function implementing the uartTransiver thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_uartTransiverTask */
__weak void uartTransiverTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
  for(;;)
